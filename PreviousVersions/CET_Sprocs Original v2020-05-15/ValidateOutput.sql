...
/****** Object:  StoredProcedure [dbo].[ValidateOutput]    Script Date: 12/16/2019 2:12:18 PM ******/
SET ANSI_NULLS ON
GO
...
-- Purpose          :  This stored procedure validates outputs for the job and saves to the InputValidation table.
-- Usage            :  n/a
-- Called by        :  n/a
