...
Change History   :  06/30/2016  Wayne Hauck added comment header
                 ...
                 :              weighting factors
                 :  09/03/2021  Robert Hansen performed the following changes:
                 ...
                 :  09/07/2021  Robert Hansen removed MiscBens and MiscCosts
...
(
    SELECT CE.CET_ID
        ,CASE
            WHEN e.MeasImpactType LIKE '%FuelSub' OR e.Channel = 'C&S' OR ri.IncentsAndDIPV - ri.GrossMeasCostPV > 0
