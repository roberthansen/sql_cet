...
/****** Object:  StoredProcedure [dbo].[CalcEmissions2013]    Script Date: 12/16/2019 1:15:01 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[CalcEmissions2013]
@JobID INT = -1,
...
--***********  Insert Emissions into temp table   ***************
...
LEFT JOIN  E3EmissionsSource2013vw em  ON s.[PA] = em.[PA]
LEFT JOIN dbo.InputMeasurevw AS e ON em.PA + CASE WHEN em.EU like 'Non_res:DEER%' THEN 'Non_res' ELSE  CASE WHEN em.EU like 'res:DEER%' THEN 'Res' ELSE  em.TS END END + CASE WHEN em.EU like 'Non_res:DEER%' THEN Replace(em.EU,'Non_Res:','') ELSE  CASE WHEN em.EU like 'res:DEER%' THEN Replace(em.EU,'res:','') ELSE  em.EU END END + em.CZ = e.PA + e.TS + e.EU + RTrim(e.CZ)
...
--LEFT JOIN  E3EmissionsSourcevw em  ON s.[Version] = em.[Version] 
LEFT JOIN  E3EmissionsSource2013vw em  ON s.[PA] = em.[PA] 
LEFT JOIN dbo.InputMeasurevw AS e ON em.PA + CASE WHEN em.EU like 'Non_res:DEER%' THEN 'Non_res' ELSE  CASE WHEN em.EU like 'res:DEER%' THEN 'Res' ELSE  em.TS END END + CASE WHEN em.EU like 'Non_res:DEER%' THEN Replace(em.EU,'Non_Res:','') ELSE  CASE WHEN em.EU like 'res:DEER%' THEN Replace(em.EU,'res:','') ELSE  em.EU END END = e.PA + e.TS + e.EU
WHERE CET_ID Is Not Null
AND s.[Version] = '2013'
...
--LEFT JOIN  E3EmissionsSourcevw em  ON s.[Version] = em.[Version] 
LEFT JOIN  E3EmissionsSource2013vw em  ON s.[PA] = em.[PA] 
LEFT JOIN dbo.InputMeasurevw AS e ON em.PA + e.TS + CASE WHEN em.EU like 'Non_res:DEER%' THEN Replace(em.EU,'Non_Res:','') ELSE  CASE WHEN em.EU like 'res:DEER%' THEN Replace(em.EU,'res:','') ELSE  em.EU END END + em.CZ = e.PA + e.TS + e.EU + RTrim(e.CZ)
WHERE CET_ID Is Not Null
AND s.[Version] = '2013'
AND em.CZ <> 'NA' AND em.TS = '0'
...
--LEFT JOIN  E3EmissionsSourcevw em  ON s.[Version] = em.[Version] 
LEFT JOIN  E3EmissionsSource2013vw em  ON s.[PA] = em.[PA] 
LEFT JOIN dbo.InputMeasurevw AS e ON em.PA + e.TS + CASE WHEN em.EU like 'Non_res:DEER%' THEN Replace(em.EU,'Non_Res:','') ELSE  CASE WHEN em.EU like 'res:DEER%' THEN Replace(em.EU,'res:','') ELSE  em.EU END END = e.PA + e.TS + e.EU
AND s.[Version] = '2013'
WHERE CET_ID Is Not Null
AND em.CZ = 'NA' AND em.TS = '0'
