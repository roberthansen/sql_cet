...
UALkWh,UALThm,UALkW_ER,UALkWh_ER,UALThm_ER,*/UWSGal,UWSGal_ER,UESkWh_IOUWater,
UESkWh_IOUWater_ER,UESkWh_TotalWater,UESkWh_TotalWater_ER,NTGRkW,NTGRkWh,NTGRThm,
NTGRCostEUL,RUL,IRkWh IR,IRkW,IRkWh,IRThm,RRkWh,RRkW,RRThm,IncentiveToOthers,
...
UnitAddTherm2ndBaseline UALThm_ER,*/UnitGalWater1stBaseline UWSGal,UnitGalWater2ndBaseline UWSGal_ER,
UnitkWhIOUWater1stBaseline UESkWh_IOUWater,UnitkWhIOUWater2ndBaseline UESkWh_IOUWater_ER,
UnitkWhTotalWater1stBaseline UESkWh_TotalWater,UnitkWhTotalWater2ndBaseline UESkWh_TotalWater_ER,
...
UALkWh_ER,UALTherms_ER UALThm_ER,*/UWSGal,UWSGal_ER,UESkWh_IOUWater,UESkWh_IOUWater_ER,
UESkWh_TotalWater,UESkWh_TotalWater_ER,NTGRkW,NTGRkWh,NTGRTherms NTGRThm,
...
UnitGalWater1stBaseline UWSGal,UnitGalWater2ndBaseline UWSGal_ER,UnitkWhIOUWater1stBaseline UESkWh_IOUWater,
UnitkWhIOUWater2ndBaseline UESkWh_IOUWater_ER,UnitkWhTotalWater1stBaseline UESkWh_TotalWater,UnitkWhTotalWater2ndBaseline UESkWh_TotalWater_ER,
...
ISNULL(UWSGal,0) Gal1,ISNULL(UWSGal_ER,0) Gal2,
ISNULL(UESkWh_IOUWater,0) kWhWater1,ISNULL(UESkWh_IOUWater_ER,0) kWhWater2,
ISNULL(UESkWh_TotalWater,0) kWhTotalWater1,ISNULL(UESkWh_TotalWater_ER) kWhTotalWater2,
...
Gal1,Gal2,kWhWater1,kWhWater2,kWhTotalWater1,kWhTotalWater2,
