...
Change History  : 2021-04-18  Robert Hansen added columns for additional load
				...
				: 2022-08-30  Robert Hansen added the following new fields related to
...
/* new water-energy nexus fields: */
    [UnitGalWater1stBaseline] [float] NULL,
    [UnitGalWater2ndBaseline] [float] NULL,
    [UnitkWhIOUWater1stBaseline] [float] NULL,
    [UnitkWhIOUWater2ndBaseline] [float] NULL,
    [UnitkWhTotalWater1stBaseline] [float] NULL,
    [UnitkWhTotalWater2ndBaseline] [float] NULL,
