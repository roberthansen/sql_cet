            ...
            CASE
                ...
                THEN
                    CASE
                        ...
                        WHEN e.Qm + e.EULq > em.Qac AND e.Qm + e.EULq < em.Qac + 1
                ...
                ELSE
                    CASE
                        ...
                        WHEN e.Qm + e.RULq > em.Qac AND e.Qm + e.RULq < em.Qac + 1
            ...
            CASE
                ...
                ELSE
                    CASE
                        ...
                        THEN e.kWh1
                        --- Quarter fully post-RUL and within EUL -- apply second baseline annual savings rate:
                        WHEN e.Qm + e.EULq > em.Qac + 1 AND e.Qm + e.RULq < em.Qac
                        THEN e.kWh2
                ...
                ELSE
                    CASE
                        ...
                        AND
                            e.Qm + e.RULq > em.Qac
                        THEN e.kWh1 * ( CONVERT( DECIMAL( 13, 10 ), e.RULq ) % 1 ) + e.kWh2 * ( 1 - CONVERT( DECIMAL( 13,10 ), e.RULq ) % 1 )
                        --- Quarter contains EUL, i.e., weight quarterly savings by time in second baseline and after:
                        WHEN
                            e.Qm + e.EULq < 4 * LEFT(em.Qtr,4)  + RIGHT(em.Qtr,1) + 1
                        AND
                            e.Qm + e.EULq > em.Qac
                        THEN e.kWh2 *  ( ( e.EULq ) - FLOOR( e.EULq ) )
                        --- Quarter fully post-RUL and pre-EUL, i.e., apply second baseline:
