            ...
            ,CASE
                ...
                THEN
                    CASE
                        ...
                        THEN im.kWh1 * ( CONVERT( DECIMAL( 13, 10 ), im.EULq ) % 1 )
                ...
                ELSE
                    CASE
                        ...
                        THEN ISNULL(im.kWh1,0) * ( CONVERT( DECIMAL( 13, 10 ), im.RULq ) % 1 ) + ISNULL(im.kWh2,0) * ( im.EULq - im.RULq )
                        ...
                        THEN ISNULL(im.kWh1,0) * ( CONVERT( DECIMAL( 13, 10 ), im.RULq ) % 1 ) + ISNULL(im.kWh2,0) * ( 1 - CONVERT( DECIMAL( 13, 10 ), im.RULq ) % 1 )
